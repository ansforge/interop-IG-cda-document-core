...
* participant[frParticipantValideurResultats].templateId contains templateIdValideur 1..1
* participant[frParticipantValideurResultats].templateId[templateIdValideur].root = "1.3.6.1.4.1.19376.1.3.3.1.5"
