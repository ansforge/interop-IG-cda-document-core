# CDA - FR Evaluation - FR Document Core (CDA) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.cda.fr.document-core|current/StructureDefinition/fr-cda-evaluation)
...
* [CDA - FR Evaluation Composant (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-evaluation-composant|0.1.0)](StructureDefinition-fr-cda-evaluation-composant.md)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-evaluation",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-evaluation-composant|0.1.0"]
      }]
    },
    {
