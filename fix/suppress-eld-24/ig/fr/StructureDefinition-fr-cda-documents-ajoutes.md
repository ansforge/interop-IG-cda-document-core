# CDA - FR Documents ajoutes - FR Document Core (CDA) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.cda.fr.document-core|current/StructureDefinition/fr-cda-documents-ajoutes)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-documents-ajoutes",
  "version" : "0.1.0",
