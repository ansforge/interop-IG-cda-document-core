...
## Modèle logique: CDA - Matériau pharmaceutique enrichi 
...
* Utilise ce/t/te Modèle logique: [CDA - FR Produit de sante](StructureDefinition-fr-cda-produit-de-sante.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.cda.fr.document-core|current/StructureDefinition/FRCDAMaterialPharm)
...
Cette structure est dérivée de [Material](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-Material.html) 
...
Autres représentations du profil : [CSV](../StructureDefinition-FRCDAMaterialPharm.csv), [Excel](../StructureDefinition-FRCDAMaterialPharm.xlsx) 
