# CDA - FR Allergies et hypersensibilites - FR Document Core (CDA) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.cda.fr.document-core|current/StructureDefinition/fr-cda-allergies-et-hypersensibilites)
...
* [CDA - FR Liste des allergies et hypersensibilites (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-liste-des-allergies-et-hypersensibilites|0.1.0)](StructureDefinition-fr-cda-liste-des-allergies-et-hypersensibilites.md)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-allergies-et-hypersensibilites",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-liste-des-allergies-et-hypersensibilites|0.1.0"]
      }]
    }]
  }
}
