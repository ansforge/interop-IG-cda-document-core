...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.cda.document.core|current/StructureDefinition/fr-cda-rang-de-la-vaccination)
