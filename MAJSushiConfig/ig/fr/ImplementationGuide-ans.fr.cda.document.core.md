...
```json
{
  ...
  "id" : "ans.fr.cda.document.core",
  "language" : "fr",
  "url" : "https://interop.esante.gouv.fr/ig/cda/document-core/ImplementationGuide/ans.fr.cda.document.core",
  "version" : "0.1.0",
  "name" : "FRCDADocumentCore",
  ...
  "packageId" : "ans.fr.cda.document.core",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
