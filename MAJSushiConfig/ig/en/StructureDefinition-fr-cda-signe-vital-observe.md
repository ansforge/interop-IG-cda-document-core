...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fr.cda.document.core|current/StructureDefinition/StructureDefinition-fr-cda-signe-vital-observe.json)
