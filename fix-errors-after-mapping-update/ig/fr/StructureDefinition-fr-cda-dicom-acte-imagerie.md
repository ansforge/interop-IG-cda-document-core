# CDA - FR DICOM Acte imagerie - FR Document Core (CDA) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.cda.fr.document-core|current/StructureDefinition/fr-cda-dicom-acte-imagerie)
...
* [CDA - FR DICOM Technique imagerie (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-technique-imagerie|0.1.0)](StructureDefinition-fr-cda-dicom-technique-imagerie.md)
* [CDA - FR DICOM Administration produit de sante (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-administration-produit-de-sante|0.1.0)](StructureDefinition-fr-cda-dicom-administration-produit-de-sante.md)
* [CDA - FR DICOM Complications (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-complications|0.1.0)](StructureDefinition-fr-cda-dicom-complications.md)
* [CDA - FR DICOM Exposition aux radiations (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-exposition-aux-radiations|0.1.0)](StructureDefinition-fr-cda-dicom-exposition-aux-radiations.md)
* [CDA - FR DICOM Object Catalog (https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-object-catalog|0.1.0)](StructureDefinition-fr-cda-dicom-object-catalog.md)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-acte-imagerie",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-technique-imagerie|0.1.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-administration-produit-de-sante|0.1.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-complications|0.1.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "http://hl7.org/cda/stds/core/StructureDefinition/Section",
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-exposition-aux-radiations|0.1.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "http://hl7.org/cda/stds/core/StructureDefinition/Section",
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-dicom-object-catalog|0.1.0"]
      }]
    }]
  }
}
